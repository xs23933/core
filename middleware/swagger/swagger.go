...
func Handler(configFns ...func(*Config)) core.HandlerFunc {
	...
	return func(c core.Ctx) error {
		if c.Method() != http.MethodGet {
			c.SendStatus(http.StatusMethodNotAllowed, "Method not allowed")
			return nil
		}
		...
		case ".css":
			c.SetHeader(core.HeaderContentType, "text/css; charset=utf-8")
		case ".js":
			c.SetHeader(core.HeaderContentType, core.MIMEApplicationJSONCharsetUTF8)
		case ".png":
			c.SetHeader(core.HeaderContentType, "image/png")
		case ".json":
			c.SetHeader(core.HeaderContentType, core.MIMEApplicationJSONCharsetUTF8)
		}
		...
		default:
			...
			http.FileServer(http.FS(swaggerFiles.FS)).ServeHTTP(c.Response(), r)
		}
		return nil
	}
}
